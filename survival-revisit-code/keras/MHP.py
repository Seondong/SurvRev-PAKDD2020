...
class MHP:
    ...
    def generate_next_event(self):
        '''Generate next event - to generate next customer visit,
           Modified generate_seq() by Sundong Kim
           What is changed?: Just make it finish when the algorithm updates lastrate'''
